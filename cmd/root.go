...
import (
	...
	"github.com/gkwa/alpinerider/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.alpinerider.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".alpinerider")
	}
